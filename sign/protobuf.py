"""
Protobuf serializer for X-Argus.
Direct translation from armxe Mobile/protobuf/protobuf.py.
Supports VARINT (wire type 0), length-delimited STRING (wire type 2),
INT32 (wire type 5), and INT64 (wire type 1).
"""
...
class ProtoWriter:
    ...
    def writeString(self, bs):
        self.writeVarint(len(bs))
        self.write(bs)
...
class ProtoBuf:
    ...
    def putInt32(self, idx, int32_val):
        self.put(ProtoField(idx, ProtoFieldType.INT32, int32_val))

    def putInt64(self, idx, int64_val):
        self.put(ProtoField(idx, ProtoFieldType.INT64, int64_val))
